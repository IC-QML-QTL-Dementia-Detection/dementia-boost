...
with composite model checkpoint serialization.
"""
...
def test_baseline_trainer_with_cached_embeddings_and_save_model(
    ...
    logger = setup_logger("test_trainer")
    ...
    trainer.train(epochs=NUM_EPOCHS, run_id="test_run_1")

    saved_checkpoint_path = Path(save_dir) / "baseline_test_run_1.pt"
